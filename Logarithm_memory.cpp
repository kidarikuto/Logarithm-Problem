...
MemoryUsage getMemoryUsage() {
    ...
    if (GetProcessMemoryInfo(hProcess, (PROCESS_MEMORY_COUNTERS*)&pmc, sizeof(pmc))) {
        ...
        usage.pagefileUsage = pmc.PagefileUsage;
        usage.privateUsage = pmc.PrivateUsage;
    } else {
...
ll bruteForce(ll y, ll g, ll p){
    MemoryUsage before = getMemoryUsage();
    ll x = 1;
    while(1){
        if (y==pow_mod<ll>(g,x,p)){ 
            MemoryUsage after = getMemoryUsage();
            std::cout << "  before Working Set Size: " << (before.workingSetSize )  << " KB\n";
            std::cout << "  after  Working Set Size: " << (after.workingSetSize )  << " KB\n";
            std::cout << "    Working Set Size: " << (after.workingSetSize - before.workingSetSize )  << " KB\n";
            std::cout << "  before Pagefile Usage: "   << (before.pagefileUsage  )  << " KB\n";
            std::cout << "  after  Pagefile Usage: "   << (after.pagefileUsage  )  << " KB\n";
            std::cout << "    Pagefile Usage: " << (after.pagefileUsage - before.pagefileUsage )  << " KB\n";
            std::cout << "  before Private Usage: "    << (before.privateUsage   )  << " KB\n";
            std::cout << "  after  Private Usage: "    << (after.privateUsage   )  << " KB\n"; 
            std::cout << "    Private Usage: "    << (after.privateUsage  - before.privateUsage )  << " KB\n"; 
            return x; 
        }
        x++;
    }
...
ll BSGS(ll y, ll g, ll p){
    ...
    rep(q,m){
        if (find(gt_index.begin(), gt_index.end(),ygqm) != gt_index.end()){
            MemoryUsage after = getMemoryUsage();
            std::cout << "  Working Set Size: " << (before.workingSetSize )  << " KB\n";
            std::cout << "  Working Set Size: " << (after.workingSetSize )  << " KB\n";
            std::cout << "  Pagefile Usage: "   << (before.pagefileUsage  )  << " KB\n";
            std::cout << "  Pagefile Usage: "   << (after.pagefileUsage  )  << " KB\n";
            std::cout << "  Private Usage: "    << (before.privateUsage   )  << " KB\n";
            std::cout << "  Private Usage: "    << (after.privateUsage   )  << " KB\n";
            return q*m + gt[ygqm];
        }
        ygqm = (ygqm*gm) % p;
    }
...
int main(){
    ...
    rep(i,10){
        ...
        // std::cout << "  Working Set Size: " << (after.workingSetSize - before.workingSetSize)/1024  << " KB\n";
        // std::cout << "  Pagefile Usage: "   << (after.pagefileUsage  - before.pagefileUsage)/1024  << " KB\n";
        // std::cout << "  Private Usage: "    << (after.privateUsage   - before.privateUsage)/1024  << " KB\n";
        // std::cout << "  Working Set Size: " << ( before.workingSetSize)/1024  << " KB\n";
        // std::cout << "  Pagefile Usage: "   << ( before.pagefileUsage)/1024  << " KB\n";
        // std::cout << "  Private Usage: "    << ( before.privateUsage)/1024  << " KB\n";
        // std::cout << "  Working Set Size: " << (after.workingSetSize)/1024  << " KB\n";
        // std::cout << "  Pagefile Usage: "   << (after.pagefileUsage)/1024  << " KB\n";
        // std::cout << "  Private Usage: "    << (after.privateUsage)/1024  << " KB\n";
